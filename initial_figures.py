...
def initial_figure_radar():
    ...
    fig.add_trace(go.Scatterpolar(
        r=r_values,
        theta= ['Tirs Assists', 'Passes Réussies', 'Ballons perdus', 'Récupérations', 'Duels aeriens gagnés', 'Tirs', 'Key Passes', 'Centres', 'Dribbles','Dribbles réussis', 'Les passes derrière la ligne','Duels gagnés'],
        fill='toself',
        opacity=.50
